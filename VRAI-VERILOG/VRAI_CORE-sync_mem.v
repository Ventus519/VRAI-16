...
INSTR_DECODER instr_decoder (
    .INSTR(INSTR_STREAM), //INSTR is not implemented yet
    .UNIT_CODE(UNIT_CODE),
    .MAIN_CODE(MAIN_CODE),
...
COUNTER counter (
    ...
    .OVERWRITE(COUNT_OVERWRITE), //see Unit 3: Jump
...
assign SW_SYS_RESULT = SYS_COUNT_RESULT;


wire [3:0] SW_SYS_DEST;
SWITCH #(4) sys_dest_ctrl (
    .IN(REG_DEST_SYS),
    .SW_EN(SYS_ACCESS & (~SYS_ACCESS_INVALID)),
    .OUT(SW_SYS_DEST)
);
