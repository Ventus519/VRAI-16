module VRAI_SYNC_CORE (CLK,
 ...
 sky130_fd_sc_hd__inv_2 _2430_ (.A(_0007_),
    ...
    .VPWR(VPWR),
    .Y(_2358_));
 sky130_fd_sc_hd__inv_2 _2431_ (.A(RESET),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a21o_2 _2461_ (.A1(_2382_),
    ...
    .VPWR(VPWR),
    .X(_2386_));
 sky130_fd_sc_hd__nor4b_2 _2462_ (.A(\INSTR[31] ),
    .B(\INSTR[29] ),
    .C(\INSTR[28] ),
    .D_N(\INSTR[30] ),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2_2 _2466_ (.A(\STATE[6] ),
    ...
    .VPWR(VPWR),
    .X(_2391_));
 sky130_fd_sc_hd__nand2_2 _2467_ (.A(\STATE[6] ),
    .B(_2389_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o31a_2 _2478_ (.A1(_0011_),
    ...
    .VPWR(VPWR),
    .X(_2401_));
 sky130_fd_sc_hd__o31ai_2 _2479_ (.A1(_0011_),
    .A2(_2398_),
    .A3(_2400_),
    .B1(_2396_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21oi_2 _2708_ (.A1(_2372_),
    ...
    .VPWR(VPWR),
    .Y(_0629_));
 sky130_fd_sc_hd__nor2_2 _2709_ (.A(RESET),
    .B(_0629_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0018_));
 sky130_fd_sc_hd__or2_2 _2710_ (.A(RESET),
    .B(\STATE[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_2 _2711_ (.A1(\STATE[6] ),
    ...
    .VPWR(VPWR),
    .Y(_0630_));
 sky130_fd_sc_hd__nor2_2 _2712_ (.A(RESET),
    .B(_0630_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _2901_ (.A(_0786_),
    ...
    .VPWR(VPWR),
    .Y(_0788_));
 sky130_fd_sc_hd__nor2_2 _2902_ (.A(RESET),
    .B(_0788_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _2953_ (.A(_0786_),
    ...
    .VPWR(VPWR),
    .Y(_0824_));
 sky130_fd_sc_hd__nor2_2 _2954_ (.A(RESET),
    .B(_0824_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _2973_ (.A(_0826_),
    ...
    .VPWR(VPWR),
    .Y(_0828_));
 sky130_fd_sc_hd__nor2_2 _2974_ (.A(RESET),
    .B(_0828_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _2992_ (.A(_0826_),
    ...
    .VPWR(VPWR),
    .Y(_0831_));
 sky130_fd_sc_hd__nor2_2 _2993_ (.A(RESET),
    .B(_0831_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _3010_ (.A(_0787_),
    ...
    .VPWR(VPWR),
    .Y(_0833_));
 sky130_fd_sc_hd__nor2_2 _3011_ (.A(RESET),
    .B(_0833_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _3028_ (.A(_0823_),
    ...
    .VPWR(VPWR),
    .Y(_0835_));
 sky130_fd_sc_hd__nor2_2 _3029_ (.A(RESET),
    .B(_0835_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _3047_ (.A(_0827_),
    ...
    .VPWR(VPWR),
    .Y(_0838_));
 sky130_fd_sc_hd__nor2_2 _3048_ (.A(RESET),
    .B(_0838_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _3065_ (.A(_0830_),
    ...
    .VPWR(VPWR),
    .Y(_0840_));
 sky130_fd_sc_hd__nor2_2 _3066_ (.A(RESET),
    .B(_0840_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _3083_ (.A(_0787_),
    ...
    .VPWR(VPWR),
    .Y(_0842_));
 sky130_fd_sc_hd__nor2_2 _3084_ (.A(RESET),
    .B(_0842_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _3102_ (.A(_0827_),
    ...
    .VPWR(VPWR),
    .Y(_0845_));
 sky130_fd_sc_hd__nor2_2 _3103_ (.A(RESET),
    .B(_0845_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _3120_ (.A(_0830_),
    ...
    .VPWR(VPWR),
    .Y(_0847_));
 sky130_fd_sc_hd__nor2_2 _3121_ (.A(RESET),
    .B(_0847_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _3138_ (.A(_0787_),
    ...
    .VPWR(VPWR),
    .Y(_0849_));
 sky130_fd_sc_hd__nor2_2 _3139_ (.A(RESET),
    .B(_0849_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _3156_ (.A(_0823_),
    ...
    .VPWR(VPWR),
    .Y(_0851_));
 sky130_fd_sc_hd__nor2_2 _3157_ (.A(RESET),
    .B(_0851_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _3174_ (.A(_0786_),
    ...
    .VPWR(VPWR),
    .Y(_0853_));
 sky130_fd_sc_hd__nor2_2 _3175_ (.A(RESET),
    .B(_0853_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _3192_ (.A(_0786_),
    ...
    .VPWR(VPWR),
    .Y(_0855_));
 sky130_fd_sc_hd__nor2_2 _3193_ (.A(RESET),
    .B(_0855_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _3210_ (.A(_0823_),
    ...
    .VPWR(VPWR),
    .Y(_0857_));
 sky130_fd_sc_hd__nor2_2 _3211_ (.A(RESET),
    .B(_0857_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or4_2 _3228_ (.A(\STATE[2] ),
    ...
    .VPWR(VPWR),
    .X(_0859_));
 sky130_fd_sc_hd__nor2_2 _3229_ (.A(_2391_),
    .B(_0859_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0860_));
 sky130_fd_sc_hd__nor2_2 _3230_ (.A(RESET),
    .B(_0860_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o22a_2 _3254_ (.A1(\INSTR[23] ),
    ...
    .VPWR(VPWR),
    .X(_0286_));
 sky130_fd_sc_hd__nor2_2 _3255_ (.A(EX_HALT),
    .B(STALL_EX),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _3257_ (.A(JMP_STREAM_COUNT),
    ...
    .VPWR(VPWR),
    .Y(_0876_));
 sky130_fd_sc_hd__nand2_2 _3258_ (.A(INSTR_ADDR[2]),
    .B(_0874_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22o_2 _3259_ (.A1(\JMP_DEST[2] ),
    ...
    .VPWR(VPWR),
    .X(_0878_));
 sky130_fd_sc_hd__o211a_2 _3260_ (.A1(INSTR_ADDR[2]),
    .A2(_0874_),
    .B1(_0878_),
    .C1(_2359_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0287_));
 sky130_fd_sc_hd__and3_2 _3261_ (.A(INSTR_ADDR[3]),
    .B(INSTR_ADDR[2]),
    .C(_0874_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a2bb2o_2 _3262_ (.A1_N(_0875_),
    ...
    .VPWR(VPWR),
    .X(_0880_));
 sky130_fd_sc_hd__or3b_2 _3263_ (.A(INSTR_ADDR[3]),
    .B(_0875_),
    .C_N(_0877_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0881_));
 sky130_fd_sc_hd__and3_2 _3264_ (.A(_2359_),
    .B(_0880_),
    .C(_0881_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0288_));
 sky130_fd_sc_hd__and3_2 _3265_ (.A(INSTR_ADDR[4]),
    .B(INSTR_ADDR[3]),
    .C(INSTR_ADDR[2]),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_2 _3266_ (.A(_0874_),
    ...
    .VPWR(VPWR),
    .X(_0883_));
 sky130_fd_sc_hd__nor2_2 _3267_ (.A(INSTR_ADDR[4]),
    .B(_0879_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o211a_2 _3269_ (.A1(\JMP_DEST[4] ),
    ...
    .VPWR(VPWR),
    .X(_0289_));
 sky130_fd_sc_hd__nand2_2 _3270_ (.A(INSTR_ADDR[5]),
    .B(_0883_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22o_2 _3271_ (.A1(\JMP_DEST[5] ),
    ...
    .VPWR(VPWR),
    .X(_0887_));
 sky130_fd_sc_hd__o311a_2 _3272_ (.A1(INSTR_ADDR[5]),
    .A2(_0875_),
    .A3(_0883_),
    .B1(_0887_),
    .C1(_2359_),
    ...
    .VPWR(VPWR),
    .X(_0290_));
 sky130_fd_sc_hd__a21oi_2 _3273_ (.A1(INSTR_ADDR[5]),
    .A2(_0883_),
    .B1(INSTR_ADDR[6]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0888_));
 sky130_fd_sc_hd__a31o_2 _3274_ (.A1(INSTR_ADDR[6]),
    .A2(INSTR_ADDR[5]),
    .A3(_0883_),
    .B1(_0875_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _3275_ (.A1_N(\JMP_DEST[6] ),
    ...
    .VPWR(VPWR),
    .X(_0890_));
 sky130_fd_sc_hd__nor2_2 _3276_ (.A(RESET),
    .B(_0890_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0291_));
 sky130_fd_sc_hd__and4_2 _3277_ (.A(INSTR_ADDR[7]),
    .B(INSTR_ADDR[6]),
    .C(INSTR_ADDR[5]),
    .D(_0882_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _3279_ (.A1_N(_0892_),
    ...
    .VPWR(VPWR),
    .X(_0893_));
 sky130_fd_sc_hd__o211a_2 _3280_ (.A1(INSTR_ADDR[7]),
    .A2(_0889_),
    .B1(_0893_),
    .C1(_2359_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0292_));
 sky130_fd_sc_hd__and3_2 _3281_ (.A(INSTR_ADDR[8]),
    .B(_0874_),
    .C(_0891_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a2bb2o_2 _3282_ (.A1_N(_0875_),
    ...
    .VPWR(VPWR),
    .X(_0895_));
 sky130_fd_sc_hd__o311a_2 _3283_ (.A1(INSTR_ADDR[8]),
    .A2(_0875_),
    .A3(_0892_),
    .B1(_0895_),
    .C1(_2359_),
    ...
    .VPWR(VPWR),
    .X(_0293_));
 sky130_fd_sc_hd__xor2_2 _3284_ (.A(INSTR_ADDR[9]),
    .B(_0894_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o211a_2 _3286_ (.A1(_0875_),
    ...
    .VPWR(VPWR),
    .X(_0294_));
 sky130_fd_sc_hd__a21oi_2 _3287_ (.A1(INSTR_ADDR[9]),
    .A2(_0894_),
    .B1(INSTR_ADDR[10]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0898_));
 sky130_fd_sc_hd__and3_2 _3288_ (.A(INSTR_ADDR[10]),
    .B(INSTR_ADDR[9]),
    .C(_0894_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o211a_2 _3290_ (.A1(\JMP_DEST[10] ),
    ...
    .VPWR(VPWR),
    .X(_0295_));
 sky130_fd_sc_hd__a31o_2 _3291_ (.A1(INSTR_ADDR[10]),
    .A2(INSTR_ADDR[9]),
    .A3(_0894_),
    .B1(INSTR_ADDR[11]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0901_));
 sky130_fd_sc_hd__and3_2 _3292_ (.A(INSTR_ADDR[11]),
    .B(INSTR_ADDR[10]),
    .C(INSTR_ADDR[9]),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_2 _3296_ (.A1(_0894_),
    ...
    .VPWR(VPWR),
    .Y(_0905_));
 sky130_fd_sc_hd__and3_2 _3297_ (.A(INSTR_ADDR[12]),
    .B(_0894_),
    .C(_0902_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o211a_2 _3299_ (.A1(\JMP_DEST[12] ),
    ...
    .VPWR(VPWR),
    .X(_0297_));
 sky130_fd_sc_hd__nor2_2 _3300_ (.A(INSTR_ADDR[13]),
    .B(_0906_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0908_));
 sky130_fd_sc_hd__and2_2 _3301_ (.A(INSTR_ADDR[13]),
    .B(_0906_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o211a_2 _3303_ (.A1(\JMP_DEST[13] ),
    ...
    .VPWR(VPWR),
    .X(_0298_));
 sky130_fd_sc_hd__xor2_2 _3304_ (.A(INSTR_ADDR[14]),
    .B(_0909_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o211a_2 _3306_ (.A1(_0875_),
    ...
    .VPWR(VPWR),
    .X(_0299_));
 sky130_fd_sc_hd__and4_2 _3307_ (.A(INSTR_ADDR[14]),
    .B(INSTR_ADDR[13]),
    .C(INSTR_ADDR[12]),
    .D(_0902_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0913_));
 sky130_fd_sc_hd__and3_2 _3308_ (.A(INSTR_ADDR[8]),
    .B(_0891_),
    .C(_0913_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0914_));
 sky130_fd_sc_hd__xor2_2 _3309_ (.A(INSTR_ADDR[15]),
    .B(_0914_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _3310_ (.A0(\JMP_DEST[15] ),
    ...
    .VPWR(VPWR),
    .X(_0916_));
 sky130_fd_sc_hd__mux2_1 _3311_ (.A0(INSTR_ADDR[15]),
    .A1(_0916_),
    .S(_0874_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0917_));
 sky130_fd_sc_hd__and2_2 _3312_ (.A(_2359_),
    .B(_0917_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0300_));
 sky130_fd_sc_hd__or2_2 _3313_ (.A(INSTR_ADDR[0]),
    .B(_0875_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o211a_2 _3314_ (.A1(\JMP_DEST[0] ),
    ...
    .VPWR(VPWR),
    .X(_0301_));
 sky130_fd_sc_hd__or2_2 _3315_ (.A(INSTR_ADDR[1]),
    .B(_0875_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o22a_2 _3319_ (.A1(\IMM[0] ),
    ...
    .VPWR(VPWR),
    .X(_0304_));
 sky130_fd_sc_hd__a32o_2 _3320_ (.A1(INSTR_STREAM[1]),
    .A2(_0015_),
    .A3(_0860_),
    .B1(_0861_),
    .B2(\IMM[1] ),
    ...
    .VPWR(VPWR),
    .X(_0305_));
 sky130_fd_sc_hd__a32o_2 _3321_ (.A1(INSTR_STREAM[2]),
    .A2(_0015_),
    .A3(_0860_),
    .B1(_0861_),
    .B2(\IMM[2] ),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _3380_ (.A1_N(\RESULT_SYS[0] ),
    ...
    .VPWR(VPWR),
    .X(_0956_));
 sky130_fd_sc_hd__nor2_2 _3381_ (.A(RESET),
    .B(_0956_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o32a_2 _3386_ (.A1(_0954_),
    ...
    .VPWR(VPWR),
    .X(_0961_));
 sky130_fd_sc_hd__nor2_2 _3387_ (.A(RESET),
    .B(_0961_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _3409_ (.A1_N(\RESULT_SYS[4] ),
    ...
    .VPWR(VPWR),
    .X(_0981_));
 sky130_fd_sc_hd__nor2_2 _3410_ (.A(RESET),
    .B(_0981_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _3417_ (.A1_N(\RESULT_SYS[5] ),
    ...
    .VPWR(VPWR),
    .X(_0988_));
 sky130_fd_sc_hd__nor2_2 _3418_ (.A(RESET),
    .B(_0988_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o32a_2 _3425_ (.A1(_0954_),
    ...
    .VPWR(VPWR),
    .X(_0995_));
 sky130_fd_sc_hd__nor2_2 _3426_ (.A(RESET),
    .B(_0995_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _3441_ (.A1_N(\RESULT_SYS[8] ),
    ...
    .VPWR(VPWR),
    .X(_1009_));
 sky130_fd_sc_hd__nor2_2 _3442_ (.A(RESET),
    .B(_1009_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _3449_ (.A1_N(\RESULT_SYS[9] ),
    ...
    .VPWR(VPWR),
    .X(_1016_));
 sky130_fd_sc_hd__nor2_2 _3450_ (.A(RESET),
    .B(_1016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22oi_2 _3465_ (.A1(\RESULT_SYS[11] ),
    ...
    .VPWR(VPWR),
    .Y(_1030_));
 sky130_fd_sc_hd__nor2_2 _3466_ (.A(RESET),
    .B(_1030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o32a_2 _3473_ (.A1(_0954_),
    ...
    .VPWR(VPWR),
    .X(_1037_));
 sky130_fd_sc_hd__nor2_2 _3474_ (.A(RESET),
    .B(_1037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _3493_ (.A1_N(\RESULT_SYS[15] ),
    ...
    .VPWR(VPWR),
    .X(_1054_));
 sky130_fd_sc_hd__nor2_2 _3494_ (.A(RESET),
    .B(_1054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22o_2 _3532_ (.A1(_1087_),
    ...
    .VPWR(VPWR),
    .X(_1092_));
 sky130_fd_sc_hd__mux2_1 _3533_ (.A0(_1092_),
    .A1(\IMM[0] ),
    .S(_1056_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _3535_ (.A(_1094_),
    ...
    .VPWR(VPWR),
    .Y(_1095_));
 sky130_fd_sc_hd__mux2_1 _3536_ (.A0(_0608_),
    .A1(_0596_),
    .S(_1093_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _3686_ (.A1_N(_2358_),
    ...
    .VPWR(VPWR),
    .X(_1246_));
 sky130_fd_sc_hd__and2_2 _3687_ (.A(_0608_),
    .B(_1246_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_1247_));
 sky130_fd_sc_hd__nor2_2 _3688_ (.A(_0608_),
    .B(_1246_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1248_));
 sky130_fd_sc_hd__or2_2 _3689_ (.A(_0608_),
    .B(_1246_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_2 _3756_ (.A(_1312_),
    ...
    .VPWR(VPWR),
    .X(_1316_));
 sky130_fd_sc_hd__mux2_1 _3757_ (.A0(\IMM[0] ),
    .A1(_1092_),
    .S(_1313_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _3872_ (.A0(_0433_),
    ...
    .VPWR(VPWR),
    .X(_1431_));
 sky130_fd_sc_hd__mux2_1 _3873_ (.A0(_2402_),
    .A1(_1431_),
    .S(_1119_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and4b_2 _3898_ (.A_N(_1446_),
    ...
    .VPWR(VPWR),
    .X(_1457_));
 sky130_fd_sc_hd__mux2_1 _3899_ (.A0(_0505_),
    .A1(_0492_),
    .S(_1117_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _3913_ (.A1_N(\RESULT_ALU[1] ),
    ...
    .VPWR(VPWR),
    .X(_1472_));
 sky130_fd_sc_hd__nor2_2 _3914_ (.A(RESET),
    .B(_1472_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_2 _3922_ (.A1(_1084_),
    ...
    .VPWR(VPWR),
    .X(_1480_));
 sky130_fd_sc_hd__a211o_2 _3923_ (.A1(_1075_),
    .A2(_1478_),
    .B1(_1480_),
    .C1(_1108_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21a_2 _3924_ (.A1(_1066_),
    ...
    .VPWR(VPWR),
    .X(_1482_));
 sky130_fd_sc_hd__mux2_1 _3925_ (.A0(_2402_),
    .A1(_1137_),
    .S(_1119_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _3951_ (.A1_N(\RESULT_ALU[2] ),
    ...
    .VPWR(VPWR),
    .X(_1509_));
 sky130_fd_sc_hd__nor2_2 _3952_ (.A(RESET),
    .B(_1509_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o2111a_2 _3973_ (.A1(\INSTR[26] ),
    ...
    .VPWR(VPWR),
    .X(_1530_));
 sky130_fd_sc_hd__mux2_1 _3974_ (.A0(_0505_),
    .A1(_0515_),
    .S(_1317_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _3986_ (.A(_0497_),
    ...
    .VPWR(VPWR),
    .Y(_1542_));
 sky130_fd_sc_hd__nor2_2 _3987_ (.A(_1075_),
    .B(_1113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1543_));
 sky130_fd_sc_hd__a211o_2 _3988_ (.A1(_1075_),
    .A2(_1097_),
    .B1(_1108_),
    .C1(_1543_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_1544_));
 sky130_fd_sc_hd__nor2_2 _3989_ (.A(_1075_),
    .B(_1101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a211o_2 _4075_ (.A1(_1623_),
    ...
    .VPWR(VPWR),
    .X(_1628_));
 sky130_fd_sc_hd__nor2_2 _4076_ (.A(_1075_),
    .B(_1525_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1629_));
 sky130_fd_sc_hd__a211o_2 _4077_ (.A1(_1075_),
    .A2(_1522_),
    .B1(_1629_),
    .C1(_1108_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21o_2 _4167_ (.A1(_1249_),
    ...
    .VPWR(VPWR),
    .X(_1716_));
 sky130_fd_sc_hd__and3_2 _4168_ (.A(_2377_),
    .B(_1715_),
    .C(_1716_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a32o_2 _4208_ (.A1(_1738_),
    ...
    .VPWR(VPWR),
    .X(_1756_));
 sky130_fd_sc_hd__nand2_2 _4209_ (.A(_2391_),
    .B(_1756_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_2 _4290_ (.A1(_0583_),
    ...
    .VPWR(VPWR),
    .Y(_1834_));
 sky130_fd_sc_hd__mux2_1 _4291_ (.A0(_0608_),
    .A1(_0596_),
    .S(_1317_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _4320_ (.A(_0527_),
    ...
    .VPWR(VPWR),
    .Y(_1864_));
 sky130_fd_sc_hd__nand2_2 _4321_ (.A(_0505_),
    .B(_0515_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_2 _4327_ (.A(_1866_),
    ...
    .VPWR(VPWR),
    .X(_1871_));
 sky130_fd_sc_hd__a21o_2 _4328_ (.A1(_2402_),
    .A2(_2414_),
    .B1(_0433_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _4341_ (.A1_N(_2368_),
    ...
    .VPWR(VPWR),
    .X(_1885_));
 sky130_fd_sc_hd__o32a_2 _4342_ (.A1(_2402_),
    .A2(_1445_),
    .A3(_1883_),
    .B1(_1450_),
    .B2(_1148_),
 ...
 sky130_fd_sc_hd__nand2_2 _4354_ (.A(_1896_),
    ...
    .VPWR(VPWR),
    .Y(_1898_));
 sky130_fd_sc_hd__nor2_2 _4355_ (.A(_0505_),
    .B(_0540_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_2 _4360_ (.A(_1898_),
    ...
    .VPWR(VPWR),
    .Y(_1904_));
 sky130_fd_sc_hd__nor2_2 _4361_ (.A(_2402_),
    .B(_0445_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_1905_));
 sky130_fd_sc_hd__nand2_2 _4362_ (.A(_2402_),
    .B(_0445_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_2 _4371_ (.A1(_0527_),
    ...
    .VPWR(VPWR),
    .Y(_1915_));
 sky130_fd_sc_hd__a21oi_2 _4372_ (.A1(_0505_),
    .A2(_1915_),
    .B1(_0493_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _4389_ (.A(_1930_),
    ...
    .VPWR(VPWR),
    .Y(_1932_));
 sky130_fd_sc_hd__or3_2 _4390_ (.A(_0505_),
    .B(_0540_),
    .C(_1901_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _4591_ (.A1_N(_2366_),
    ...
    .VPWR(VPWR),
    .X(_2127_));
 sky130_fd_sc_hd__a22oi_2 _4592_ (.A1(_2377_),
    .A2(_1272_),
    .B1(_1273_),
    .B2(_1149_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _4598_ (.A1_N(\RESULT_BIT[8] ),
    ...
    .VPWR(VPWR),
    .X(_2134_));
 sky130_fd_sc_hd__nor2_2 _4599_ (.A(RESET),
    .B(_2134_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0382_));
 sky130_fd_sc_hd__o2bb2a_2 _4600_ (.A1_N(_2377_),
    .A2_N(_1260_),
    .B1(_1333_),
    .B2(_0572_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21oi_2 _4612_ (.A1(_2145_),
    ...
    .VPWR(VPWR),
    .Y(_0383_));
 sky130_fd_sc_hd__mux2_1 _4613_ (.A0(_0608_),
    .A1(_0570_),
    .S(_1093_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _4650_ (.A1_N(\RESULT_BIT[12] ),
    ...
    .VPWR(VPWR),
    .X(_2182_));
 sky130_fd_sc_hd__nor2_2 _4651_ (.A(RESET),
    .B(_2182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _4657_ (.A1_N(_1149_),
    ...
    .VPWR(VPWR),
    .X(_2188_));
 sky130_fd_sc_hd__o2bb2a_2 _4658_ (.A1_N(_2377_),
    .A2_N(_1189_),
    .B1(_1333_),
    .B2(_0437_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _4664_ (.A1_N(\RESULT_BIT[13] ),
    ...
    .VPWR(VPWR),
    .X(_2195_));
 sky130_fd_sc_hd__nor2_2 _4665_ (.A(RESET),
    .B(_2195_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_2 _4679_ (.A1(_2207_),
    ...
    .VPWR(VPWR),
    .Y(_0388_));
 sky130_fd_sc_hd__o21ai_2 _4680_ (.A1(_2402_),
    .A2(_1093_),
    .B1(_1414_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _4691_ (.A1_N(\RESULT_BIT[15] ),
    ...
    .VPWR(VPWR),
    .X(_2220_));
 sky130_fd_sc_hd__nor2_2 _4692_ (.A(RESET),
    .B(_2220_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_2 _4695_ (.A(\RESULT_MEM[0] ),
    ...
    .VPWR(VPWR),
    .X(_2223_));
 sky130_fd_sc_hd__o211a_2 _4696_ (.A1(MEM_LD_DATA[0]),
    .A2(_2222_),
    .B1(_2223_),
    .C1(_2359_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_2 _4697_ (.A(\RESULT_MEM[1] ),
    ...
    .VPWR(VPWR),
    .X(_2224_));
 sky130_fd_sc_hd__o211a_2 _4698_ (.A1(MEM_LD_DATA[1]),
    .A2(_2222_),
    .B1(_2224_),
    .C1(_2359_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_2 _4699_ (.A(\RESULT_MEM[2] ),
    ...
    .VPWR(VPWR),
    .X(_2225_));
 sky130_fd_sc_hd__o211a_2 _4700_ (.A1(MEM_LD_DATA[2]),
    .A2(_2222_),
    .B1(_2225_),
    .C1(_2359_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_2 _4701_ (.A(\RESULT_MEM[3] ),
    ...
    .VPWR(VPWR),
    .X(_2226_));
 sky130_fd_sc_hd__o211a_2 _4702_ (.A1(MEM_LD_DATA[3]),
    .A2(_2222_),
    .B1(_2226_),
    .C1(_2359_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_2 _4703_ (.A(\RESULT_MEM[4] ),
    ...
    .VPWR(VPWR),
    .X(_2227_));
 sky130_fd_sc_hd__o211a_2 _4704_ (.A1(MEM_LD_DATA[4]),
    .A2(_2222_),
    .B1(_2227_),
    .C1(_2359_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_2 _4705_ (.A(\RESULT_MEM[5] ),
    ...
    .VPWR(VPWR),
    .X(_2228_));
 sky130_fd_sc_hd__o211a_2 _4706_ (.A1(MEM_LD_DATA[5]),
    .A2(_2222_),
    .B1(_2228_),
    .C1(_2359_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_2 _4707_ (.A(\RESULT_MEM[6] ),
    ...
    .VPWR(VPWR),
    .X(_2229_));
 sky130_fd_sc_hd__o211a_2 _4708_ (.A1(MEM_LD_DATA[6]),
    .A2(_2222_),
    .B1(_2229_),
    .C1(_2359_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_2 _4709_ (.A(\RESULT_MEM[7] ),
    ...
    .VPWR(VPWR),
    .X(_2230_));
 sky130_fd_sc_hd__o211a_2 _4710_ (.A1(MEM_LD_DATA[7]),
    .A2(_2222_),
    .B1(_2230_),
    .C1(_2359_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_2 _4711_ (.A(\RESULT_MEM[8] ),
    ...
    .VPWR(VPWR),
    .X(_2231_));
 sky130_fd_sc_hd__o211a_2 _4712_ (.A1(MEM_LD_DATA[8]),
    .A2(_2222_),
    .B1(_2231_),
    .C1(_2359_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_2 _4713_ (.A(\RESULT_MEM[9] ),
    ...
    .VPWR(VPWR),
    .X(_2232_));
 sky130_fd_sc_hd__o211a_2 _4714_ (.A1(MEM_LD_DATA[9]),
    .A2(_2222_),
    .B1(_2232_),
    .C1(_2359_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_2 _4715_ (.A(\RESULT_MEM[10] ),
    ...
    .VPWR(VPWR),
    .X(_2233_));
 sky130_fd_sc_hd__o211a_2 _4716_ (.A1(MEM_LD_DATA[10]),
    .A2(_2222_),
    .B1(_2233_),
    .C1(_2359_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_2 _4717_ (.A(\RESULT_MEM[11] ),
    ...
    .VPWR(VPWR),
    .X(_2234_));
 sky130_fd_sc_hd__o211a_2 _4718_ (.A1(MEM_LD_DATA[11]),
    .A2(_2222_),
    .B1(_2234_),
    .C1(_2359_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_2 _4719_ (.A(\RESULT_MEM[12] ),
    ...
    .VPWR(VPWR),
    .X(_2235_));
 sky130_fd_sc_hd__o211a_2 _4720_ (.A1(MEM_LD_DATA[12]),
    .A2(_2222_),
    .B1(_2235_),
    .C1(_2359_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_2 _4721_ (.A(\RESULT_MEM[13] ),
    ...
    .VPWR(VPWR),
    .X(_2236_));
 sky130_fd_sc_hd__o211a_2 _4722_ (.A1(MEM_LD_DATA[13]),
    .A2(_2222_),
    .B1(_2236_),
    .C1(_2359_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_2 _4723_ (.A(\RESULT_MEM[14] ),
    ...
    .VPWR(VPWR),
    .X(_2237_));
 sky130_fd_sc_hd__o211a_2 _4724_ (.A1(MEM_LD_DATA[14]),
    .A2(_2222_),
    .B1(_2237_),
    .C1(_2359_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_2 _4725_ (.A(\RESULT_MEM[15] ),
    ...
    .VPWR(VPWR),
    .X(_2238_));
 sky130_fd_sc_hd__o211a_2 _4726_ (.A1(MEM_LD_DATA[15]),
    .A2(_2222_),
    .B1(_2238_),
    .C1(_2359_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xor2_2 _4823_ (.A(_2318_),
    ...
    .VPWR(VPWR),
    .X(_2323_));
 sky130_fd_sc_hd__a21oi_2 _4824_ (.A1(_2391_),
    .A2(_2323_),
    .B1(RESET),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_2 _4853_ (.A1(_2344_),
    ...
    .VPWR(VPWR),
    .Y(_0425_));
 sky130_fd_sc_hd__or2_2 _4854_ (.A(_2387_),
    .B(_2392_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_2 _4856_ (.A_N(\STATE[5] ),
    ...
    .VPWR(VPWR),
    .X(_2347_));
 sky130_fd_sc_hd__o21a_2 _4857_ (.A1(EX_HALT),
    .A2(_2347_),
    .B1(_2359_),
    .VGND(VGND),
    .VNB(VGND),
